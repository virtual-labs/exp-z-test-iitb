function activity1_p1() {
    ...
    btn && btn.remove();
    let btn_txt = get_collapse_btn_text('Selecting alpha value', 'div-alpha');
    maindiv.innerHTML += `
      ${btn_txt}
      <div class="collapse divide" id="div-alpha">
...
// 		document.getElementById('act1-p1-btn-2')
// 	);
// 	if (inp.value != '0') {
...
//          if (z_table[i].z === x2) {
//             y2 = z_table[i][alpha];
//             y1 = z_table[i + 1][alpha];
//             break;
//          }
//       }
//       let m = (y1 - y2) / (x1 - x2);
//       let c = y1 - m * x1;
//       z_alpha = parseFloat((m * x + c).toFixed(3));
//       console.log(x1, x2);
//       console.log(y1, y2);
//       console.log('z_alpha', z_alpha);
//       let s_2: HTMLDivElement = <HTMLDivElement>document.getElementById('s2');
